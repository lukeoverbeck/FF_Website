    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDownIcon
          ...
          className="absolute right-2 pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden"
        />
        <ChevronUpIcon
          data-slot="accordion-trigger-icon"
          className="absolute right-2 pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline"
        />
      </AccordionPrimitive.Trigger>
